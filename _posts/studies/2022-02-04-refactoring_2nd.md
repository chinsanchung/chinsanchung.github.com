...
toc_sticky: true
toc_labe: 목차
description: '리팩터링 예시', '리팩터링의 원칙', '코드에서 나는 악취'의 내용을 정리합니다.
excerpt: '리팩터링 예시', '리팩터링의 원칙', '코드에서 나는 악취'의 내용을 정리합니다.
tags:
  - book
---

마틴 파울러의 『리팩터링 2판』에 대해 정리하는 목적의 글입니다. 1, 2, 3장의 내용을 담고 있습니다.
