...
(data.loc[data['income'] == '>50K']['occupation'].value_counts() / data['occupation'].value_counts()) * 100
'''
...
(data.loc[data['income'] == '>50K']['education-num'].value_counts() / data['education-num'].value_counts()) * 100
'''
1.0      1.388889
2.0      3.603604
3.0      4.899777
